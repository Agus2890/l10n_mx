...
class IrAttachmentFacturaeMx(models.Model):
            ...
            if pac_params_ids:
                ...
                if True:  # if wsdl_client:
                    ...
                    if codigo_validacion == 200:
                        ...
                        msg=resultados_mensaje
                        cfdi_xml =str(base64.b64decode(resultado['resultados'][0]['cfdiTimbrado'] or ''),encoding='utf-8') #cfdi_data['cfdi_xml']#.pop('cfdi_xml')
                        
                    else:
                        msg = "Codigo de Error:" + str(codigo_validacion) + str(resultados_mensaje)
    ...
    def _upload_ws_file_old(self, fdata=None):
        """
        ...
        pac_params_obj = invoice_obj.env['params.pac'] 
        for ir_attachment_facturae_mx_id in self:
            invoice = ir_attachment_facturae_mx_id.move_id

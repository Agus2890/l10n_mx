...
from ernesto.account_financial_report_qweb.report.general_ledger import GeneralLedgerReport


class GeneralLedgerXml(models.AbstractModel):
    """
...
#         }
#         return self.env['report'].render('l10n_mx_eaccounting.general_ledgder', docargs)
